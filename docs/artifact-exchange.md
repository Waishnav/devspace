...
Native-file download currently requires Linux, macOS, FreeBSD, OpenBSD, or
NetBSD because publication is anchored through open directory descriptors. The
tool is not registered on Windows.
